...
class CountryHelper
{
    ...
    {
        return match ($locale) {
            'en' => self::getCountriesListInEnglish(),
            'ar' => self::getCountriesListInArabic(),
            default => [],
        };
    }


    public static function getCountriesListInEnglish(): array
    {
        return Cache::remember('countries_en', 60, function () {
            return array(
                "AF" => "Afghanistan",
                "AL" => "Albania",
                "DZ" => "Algeria",
    ...
    public static function getCountriesListInArabic(): array
    {
        return Cache::remember('countries_ar', 60, function () {
            return array(
                "AW" => "آروبا",
                "AZ" => "أذربيجان",
                "AM" => "أرمينيا",
