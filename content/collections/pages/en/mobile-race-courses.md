---
id: 5e799d05-427c-4f0d-b99f-b2c41db8d4c5
blueprint: mobile_page
title: 'Mobile Race Courses'
mobile_builder:
  -
    id: mkdt2dqm
    heading: Courses
    cards_replicator:
      ...
      -
        ...
        card_title: 'THE RUN'
        card_description: |-
          A flat coastal run featuring multiple loops through the heart of the race village. Providing an incredible atmosphere with fans and supporters cheering on just steps away, while also offering more frequent access to hydration stations Average daytime temperature:
          21 - 24 degrees.
        button_group:
          button_text: 'Read More'
      ...
      -
        ...
        image:
          - new-project-(12).webp
        card_title: 'COMMUNITY RACES'
        card_description: 'Choose from a variety of events suited for all ages and fitness levels. Check out the full list of swimming, biking and running races.'
        button_group:
          button_text: 'Read More'
          buttonc_link: 'entry::3ca37afb-8a18-4994-8460-627d9cd48a78'
        type: card
        enabled: true
  ...
  -
    ...
    heading_and_image_replicator:
      -
        ...
        heading: 'SWIM - 1.9km'
        image:
          - 11_csby_swim_middle-distance-1.9km-pdf-(1).jpg
        type: data_card
        enabled: true
      -
        id: mkdth65a
        heading: 'BIKE - 96km'
        image:
          - 03_csby_bike_middle-distance-96km-1536x1161.jpg
        type: data_card
        enabled: true
      -
        id: mkdthv8j
        heading: 'RUN - 21.1km'
        image:
          - run_long-middle-olympic-distance_050425-1-1536x864.jpg
        type: data_card
        enabled: true
    type: heading_with_image_sets
    enabled: true
